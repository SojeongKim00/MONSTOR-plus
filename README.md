...
Therefore, we propose MONSTOR+ to extend MONSTOR in 2 aspects: **being applicable under two diffusion models and improving performance**, the IC and LT models. MONSTOR+ contains 2 main contributions : (a) the augmented node feature and (b) advanced aggregator.
